...
def index(request):
    ...
    milestones=[
        {"time":"Now", "place":"Oracle", "position":"Application Engineer", "period":"Sep 2020 - Present",  "description":"<ul><li>Involved in the development of digital assistant for Oracle's latest generation ERP suite that is utilized by multiple Fortune 500 companies.</li><li>Responsible for development and deployment of the digital assistant for internal use at Oracle.</li><li>Developer point of contact for 10+ teams working on the product and responsible for the integration of their modules.</li><li>Responsible for design, development and maintenance of internal tools that are used by 15+ teams across the company for development, testing and analytics</li></ul>"},
        {"time":"'20", "place":"CET, Trivandrum", "position":"B.Tech(Hons)", "period":"Aug 2016 - May 2020",  "description":"<ul><li>Majored in Computer Science and Engineering</li><li>CGPA: 8.56</li><li>Volunteer @ FOSS Cell CET</li><li>Volunteer @ IEEE CET</li></ul>"},
        {"time":"'19", "place":"Nissan Digital", "position":"Software Engineering Intern", "period":"Jun 2019 - Jul 2019",  "description":"<ul><li>Worked on approximating the NP-hard packing problem of determining the usable trunk volume of a car.</li><li>Built a tool that allows engineers to easily test solutions for the problem.</li></ul>"},
        {"time":"'18", "place":"CLAP Research", "position":"Machine Learning Intern","period":"Jun 2018 - Jul 2018",  "description":"<ul><li>Worked on developing models that rank paragraphs for question answering.</li><li>Built workflows for developing and tuning the model.</li></ul>"},
    ]
    projects=[
